...
export default function App() {
  ...
  useEffect(() => {
    // Bloquear o scroll quando a Hero estiver na tela
    if (!showContent) {
  ...
  return (
    <main
      ...
      onClick={() => !showContent && setShowContent(true)}
    >
      <AnimatePresence mode="wait">
        {!showContent ? (
          <motion.section
            ...
            className="relative min-h-[18px] h-[100dvh] md:h-screen md:min-h-[680px] w-full flex flex-col items-center justify-center bg-white overflow-hidden cursor-pointer"
          >
